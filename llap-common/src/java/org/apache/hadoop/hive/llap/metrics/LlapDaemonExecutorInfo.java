...
public enum LlapDaemonExecutorInfo implements MetricsInfo {
  ...
  ExecutorTotalPreemptionTimeToKill("Total amount of time taken for killing tasks due to preemption"),
  ExecutorTotalPreemptionTimeLost("Total useful cluster time lost because of preemption"),
  ExecutorPercentileTimeToKill("Percentile time to kill for preempted tasks"),
  ExecutorPercentileTimeLost("Percentile cluster time wasted due to preemption"),
  ExecutorMaxPreemptionTimeToKill("Max time for killing preempted task"),
  ExecutorMaxPreemptionTimeLost("Max cluster time lost due to preemption"),
